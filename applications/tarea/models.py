...
class Tarea(models.Model):
    ...
    tipo_tarea = models.ForeignKey(TipoTarea, on_delete=models.PROTECT, related_name='TipoTarea',blank=True, null=True)
    ...
    prioridad = models.IntegerField('Prioridad',choices=PRIORIDAD,blank=True, null=True)
