...
urlpatterns = [
    ...
    path('salida-garantia/entregar/<pk>/', views.SalidaReclamoGarantiaObservacionUpdateView.as_view(), name='salida_garantia_entregar'),
    path('salida-garantia/pdf/<int:id_salida>/', views.SalidadReclamoGarantiaPdfView.as_view(), name='salida_garantia_pdf'),
