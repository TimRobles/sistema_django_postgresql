...
class OfertaProveedor(models.Model):
    ...
    total_gravada = models.DecimalField('Total Grabada', max_digits=14, decimal_places=2, default=0)
...
class OfertaProveedorDetalle(models.Model):
    ...
    sub_total = models.DecimalField('Total Anticipo', max_digits=14, decimal_places=2, default=0)
    ...
    oferta_proveedor = models.ForeignKey(OfertaProveedor, on_delete=models.CASCADE)
