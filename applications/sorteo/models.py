...
# \copy sorteo_ticket(ticket, razon_social, ruc, contacto, elegido, bloqueo) from /webapps/archivos/TAB_MARKETING_004_Tickets_Sorteo.csv DELIMITER ';' HEADER CSV;
# \copy sorteo_ticket(ticket, razon_social, ruc, contacto, elegido, bloqueo) from /home/multiplay/Documents/VirtualBox/Archivos/TAB_MARKETING_004_Tickets_Sorteo.csv DELIMITER ';' HEADER CSV;
