...
urlpatterns = [
    ...
    path('requerimiento-material-proveedor/enviar_correo/<slug>/', views.RequerimientoMaterialProveedorEnviarCorreoView.as_view(), name='requerimiento_material_proveedor_enviar_correo'),
