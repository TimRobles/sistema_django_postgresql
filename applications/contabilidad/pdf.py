...
def dataTelecreditoSolicitar(movimientos, telecredito, fuenteBase):
    encabezado = []
    encabezado.append(parrafoCentro("Tipo", fuenteBase, 8, 'Bold'))
    encabezado.append(parrafoCentro("Concepto", fuenteBase, 8, 'Bold'))
    encabezado.append(parrafoCentro("Fecha de Vencimiento", fuenteBase, 8, 'Bold'))
    ...
    for recibo in movimientos:
        ...
        fila.append(parrafoCentro(recibo[3].strftime('%d/%m/%Y'), fuenteBase)) #Fecha
        fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(recibo[4]), fuenteBase)) #Monto
        total += recibo[4]
    ...
    fila.append(vacio())
    fila.append(parrafoDerecha("Total:", fuenteBase, 8, 'Bold'))
    fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(total), fuenteBase, 8, 'Bold'))
    
    data_recibos.append(fila)

    return data_recibos

def generarTelecreditoSolicitarPdf(titulo, vertical, logo, pie_pagina, fecha_hoy, movimientos, telecredito, color):
    fuenteBase = "ComicNeue"

    data_recibos = dataTelecreditoSolicitar(movimientos, telecredito, fuenteBase)
...
def dataTelecreditoCerrar(movimientos, telecredito, fuenteBase):
    encabezado = []
    encabezado.append(parrafoCentro("Tipo", fuenteBase, 8, 'Bold'))
    encabezado.append(parrafoCentro("Concepto", fuenteBase, 8, 'Bold'))
    encabezado.append(parrafoCentro("Fecha de Vencimiento", fuenteBase, 8, 'Bold'))
    ...
    for recibo in movimientos:
        ...
        fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(recibo[4]), fuenteBase))
        fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(recibo[5]), fuenteBase))
        fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(recibo[6]), fuenteBase))
        fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(recibo[10]), fuenteBase))
        fila.append(parrafoCentro(recibo[11], fuenteBase))
    ...
    fila.append(parrafoDerecha("Total:", fuenteBase, 8, 'Bold'))
    fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(total), fuenteBase, 8, 'Bold'))
    fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(total_mora), fuenteBase, 8, 'Bold'))
    fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(total_redondeo), fuenteBase, 8, 'Bold'))
    fila.append(parrafoDerecha(telecredito.moneda.simbolo + ' ' + intcomma(total_pagado), fuenteBase, 8, 'Bold'))
...
def generarTelecreditoCerrarPdf(titulo, vertical, logo, pie_pagina, fecha_hoy, movimientos, telecredito, color):
    fuenteBase = "ComicNeue"

    data_recibos, data_telecreditos = dataTelecreditoCerrar(movimientos, telecredito, fuenteBase)
