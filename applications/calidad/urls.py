...
urlNotaControlCalidadStock = [
    ...
    path('nota-control-calidad-stock/registrar-devolucion/', views.NotaControlCalidadStockNotaDevolucionCreateView.as_view(), name='nota_control_calidad_stock_registrar_devolucion'),
    path('nota-control-calidad-stock/registrar-devolucion-prestamo/', views.NotaControlCalidadStockNotaDevolucionPrestamoCreateView.as_view(), name='nota_control_calidad_stock_registrar_devolucion_prestamo'),
