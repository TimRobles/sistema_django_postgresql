...
urlNotaControlCalidadStock = [
    ...
    path('nota-control-calidad-stock/registrar-devolucion-prestamo/', views.NotaControlCalidadStockNotaDevolucionCreateView.as_view(), name='nota_control_calidad_stock_registrar_devolucion_prestamo'),
