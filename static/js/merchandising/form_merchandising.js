function seleccionar_familia(id_familia) {
    ...
    url = '/merchandising/subfamilia/' + id_familia + '/';
...
function seleccionar_subfamilia(id_subfamilia) {
    ...
    url = '/merchandising/unidad/' + id_subfamilia + '/';
...
function seleccionar_marca(id_marca) {
    ...
    if (id_marca=="") {
        url = '/merchandising/modelo-merchandising/0/';
        
    } else {
        url = '/merchandising/modelo-merchandising/' + id_marca + '/';
