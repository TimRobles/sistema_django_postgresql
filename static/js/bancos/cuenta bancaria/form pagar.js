function seleccionar_deuda(deuda) {
    texto = getSelectedValueText(deuda, deuda.value);
    textos = texto.split(' ');
...
$('#id_deuda').unbind().on('change', function (e) {
    seleccionar_deuda(e.target);
})
